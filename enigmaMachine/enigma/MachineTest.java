...
public class MachineTest {
    ...
    public void testConvertMsg() {
        ...
        assertEquals("QVPQSOKOILPUBKJZPISFXDWBHCNSCXNUOAATZXSRCFYDGU",
                mach.convert("FROMHISSHOULDERHIAWATHATOOKTHECAMERAOFROSEWOOD"));
    }

    private Machine mach2() {
        Machine mach = new Machine(AZ, 5, 3, ROTORS.values());
        mach.insertRotors(ROTORS1);
        mach.setRotors(SETTING1, RINGSTELLUNG1);
        return mach;
    }
    ...
    public void testRingstellung() {
        Machine mach = mach2();
        mach.setPlugboard(new Permutation("(BQ)", AZ));
        assertEquals("THISISFORATESTOHMYLORDYLORDAMONGUSSUS",
                mach.convert("SUEQGBTZCUOKBEGDFOVGIMKCNUINIQVHQGEWI"));
    }
}
